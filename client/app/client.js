Template.registerHelper("verbOptions", function() {
    return [
		...
		{value:"418",label:"418 - I am a teapot"},
		...
		{value:"425",label:"425 - Unordered Collection not supported by webob"}, 
		...
		{value:"450",label:"450 - 4Blocked by Windows Parental Controls"},
		...
		{value:"499",label:"499 - Client Closed Request not supported by webob"},
		...
		{value:"598",label:"598 - Network read timeout error not supported by webob"},
		{value:"599",label:"599 - Network connect timeout error not supported by webob"}
    ];
});
